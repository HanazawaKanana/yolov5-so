...
class LoadImages:
    ...
    def __init__(self, path, img_size=640, stride=32, auto=True):
        ...
        self.video_flag = [False] * ni + [True] * nv##文件是否为视频的flag
        self.mode = 'image'
        self.auto = auto
        if any(videos):
    ...
    def __next__(self):
        ...
        # Padded resize
        img = letterbox(img0, self.img_size, stride=self.stride, auto=self.auto)[0]##图像resize，letterbox在utils.augmentations中  (640,480,3)
